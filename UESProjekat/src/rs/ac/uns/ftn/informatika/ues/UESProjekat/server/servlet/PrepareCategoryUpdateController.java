...
public class PrepareCategoryUpdateController extends HttpServlet {

private static final long serialVersionUID = 1L;
	
	private static Logger log = Logger.getLogger(PrepareCategoryUpdateController.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if ((id != null) && (!id.equals(""))) {
				request.setAttribute("category", categoryDaoLocal.findById(Integer.parseInt(id)));
