...
public class PreparePersonalUpdateController extends HttpServlet {

private static final long serialVersionUID = 1L;
	
	private static Logger log = Logger.getLogger(PreparePersonalUpdateController.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if ((userId != null) && (!userId.equals(""))) {
				...
				getServletContext().getRequestDispatcher("/updatePersonalInfo.jsp").forward(request, response);
			}
